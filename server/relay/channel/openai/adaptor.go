...
import (
	...
	"github.com/ChrisSong1994/7x-api/relay/channel/ai360"
	"github.com/ChrisSong1994/7x-api/relay/channel/lingyiwanwu"

	//"github.com/ChrisSong1994/7x-api/relay/channel/minimax"
	"github.com/ChrisSong1994/7x-api/relay/channel/openrouter"
	"github.com/ChrisSong1994/7x-api/relay/channel/xinference"
	relaycommon "github.com/ChrisSong1994/7x-api/relay/common"
	"github.com/ChrisSong1994/7x-api/relay/common_handler"
	...
	"github.com/ChrisSong1994/7x-api/setting/reasoning"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "7X API")
		}
	}
	return nil
}
