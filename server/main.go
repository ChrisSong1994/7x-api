...
import (
	...
	"github.com/ChrisSong1994/7x-api/oauth"
	"github.com/ChrisSong1994/7x-api/relay"
	"github.com/ChrisSong1994/7x-api/router"
	"github.com/ChrisSong1994/7x-api/service"
	_ "github.com/ChrisSong1994/7x-api/setting/performance_setting"
...
func main() {
	...
	common.SysLog("7X API " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/Calcium-Ion/7x-api", err),
				"type":    "new_api_panic",
			},
		})
	}))
