...
> = {
  emerald: {
    activeText: 'text-[#1dbf69] dark:text-[#2ed97c]',
    activeBorder: 'border-[#1dbf69] dark:border-[#2ed97c]',
    badge:
      'bg-[#1dbf69]/10 text-[#1dbf69] dark:bg-[#2ed97c]/10 dark:text-[#2ed97c]',
  },
  amber: {
    activeText: 'text-[#19a85a] dark:text-[#29b86a]',
    activeBorder: 'border-[#19a85a] dark:border-[#29b86a]',
    badge:
      'bg-[#19a85a]/10 text-[#19a85a] dark:bg-[#29b86a]/10 dark:text-[#29b86a]',
  },
  blue: {
    activeText: 'text-[#1dbf69] dark:text-[#2ed97c]',
    activeBorder: 'border-[#1dbf69] dark:border-[#2ed97c]',
    badge: 'bg-[#1dbf69]/10 text-[#1dbf69] dark:bg-[#2ed97c]/10 dark:text-[#2ed97c]',
  },
  violet: {
    activeText: 'text-[#17a050] dark:text-[#27b060]',
    activeBorder: 'border-[#17a050] dark:border-[#27b060]',
    badge:
      'bg-[#17a050]/10 text-[#17a050] dark:bg-[#27b060]/10 dark:text-[#27b060]',
  },
}
      ...
      >
        ...
        >
          ...
          <div className='ml-auto flex items-center gap-2 pr-2 sm:pr-3'>
            <span className='inline-block size-1.5 rounded-full bg-[#1dbf69] shadow-[0_0_8px_rgba(29,191,105,0.45)]' />
...
function Command(props: { children: ReactNode }) {
  return (
    <span className='font-medium text-[#1dbf69] dark:text-[#2ed97c]'>
      {props.children}
    </span>
  )
}
...
function Flag(props: { children: ReactNode }) {
  return (
    <span className='text-[#19a85a] dark:text-[#29b86a]'>{props.children}</span>
  )
}

function Key(props: { children: ReactNode }) {
  return (
    <span className='text-[#1dbf69] dark:text-[#3ee98c]'>{props.children}</span>
  )
}

function StringText(props: { children: ReactNode }) {
  return (
    <span className='text-[#2ac96d] dark:text-[#5ae99d]'>{props.children}</span>
  )
}

function NumberText(props: { children: ReactNode }) {
  return (
    <span className='font-medium text-[#1dbf69] dark:text-[#4ae98c]'>
      {props.children}
    </span>
  )
}
