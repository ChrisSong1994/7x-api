  ...
  return (
    <section className='relative z-10 flex flex-col items-center overflow-hidden px-6 pt-28 pb-16 md:pt-36 md:pb-24'>
      ...
      <div
        ...
        style={{
          background: [
            'radial-gradient(ellipse 60% 50% at 20% 20%, oklch(0.65 0.20 150 / 70%) 0%, transparent 70%)',
            'radial-gradient(ellipse 50% 40% at 80% 15%, oklch(0.60 0.18 145 / 50%) 0%, transparent 70%)',
            'radial-gradient(ellipse 40% 35% at 40% 80%, oklch(0.70 0.15 155 / 35%) 0%, transparent 70%)',
          ].join(', '),
        }}
      />
      {/* Grid pattern */}
      ...
      <div className='flex max-w-3xl flex-col items-center text-center'>
        ...
        >
          ...
          <br />
          <span className='bg-gradient-to-r from-[#1dbf69] via-[#2ed97c] to-[#3ee98c] bg-clip-text text-transparent'>
